...
<div class="row justify-content-center">
	<div class="col-11">
		<div class="text-center">
			...
			<h3 class="mt-4 text-white">{{ __('We are currently performing maintenance') }}</h3>
			<p class="text-white-50">{{ __("We're making the system more awesome. We'll be back shortly.") }}</p>
			...
			<div class="row mt-5">
				<div class="col-md-4">
					<div class="text-center mt-3 ps-1 pe-1">
						...
						<h5 class="text-uppercase mt-3 text-white">{{ __('Why is the Site Down?') }}</h5>
				...
				<div class="col-md-4">
					<div class="text-center mt-3 ps-1 pe-1">
						...
						<h5 class="text-uppercase mt-3 text-white">{{ __('What is the Downtime?') }}</h5>
				...
				<div class="col-md-4">
					<div class="text-center mt-3 ps-1 pe-1">
						...
						<h5 class="text-uppercase mt-3 text-white">{{ __('Do you need Support?') }}</h5>
