	...
	<div class="col-lg-4">
		<div class="card">
			<div class="card-body p-4">
				...
				<div class="text-center">
					<h3 class="mt-4 text-uppercase">{{ __('Whoops! Page not found') }}</h3>
					<p class="text-muted mb-0">
						{{ __('It\'s looking like you may have taken a wrong turn.') }}
						{{ __('Don\'t worry... it happens to the best of us.') }}
						{{ __('You might want to check your internet connection.') }}
						{{ __('Here\'s a little tip that might help you get back on track.') }}
					</p>
				</div>
			</div>
		</div>
		...
		<div class="row mt-3">
			<div class="col-6 text-start">
				<a href="{{ url()->previous() }}" class="btn btn-success waves-effect waves-light">
